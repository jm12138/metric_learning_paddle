...
add_arg('train_batch_size', int, 64, "Minibatch size.")
add_arg('test_batch_size', int, 64, "Minibatch size.")
add_arg('image_shape', str, "3,128,128", "input image size")
add_arg('class_dim', int, 751, "Class number.")
...
add_arg('test_iter_step', int, 500, "test_iter_step.")
add_arg('save_iter_step', int, 500, "save_iter_step.")
add_arg('use_gpu', bool, True, "Whether to use GPU or not.")
add_arg('pretrained_model', str, None, "Whether to use pretrained model.")
add_arg('checkpoint', str, None, "Whether to resume checkpoint.")
add_arg('model_save_dir', str, "save_pair", "model save directory")
add_arg('loss_name', str, "eml", "Set the loss type to use.")
add_arg('samples_each_class', int, 4, "samples_each_class.")
