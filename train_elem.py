...
add_arg('test_batch_size', int, 256, "Minibatch size.")
...
add_arg('pretrained_model', str, 'pretrained_model/MobileNetV3_large_x1_25_pretrained', "Whether to use pretrained model.")
add_arg('checkpoint', str, None, "Whether to resume checkpoint.")
add_arg('model_save_dir', str, "save_elem", "model save directory")
add_arg('loss_name', str, "arcmargin", "Set the loss type to use.")
